...
type ParagraphProps = {
  size: 'h1' | 'h2' | 'h3' | 'h3-regular' | 'h4' | 'h5' | 'h6' | 'h6-regular' | 'h6-thin' | 'title' | 'subtitle' | 'mini-title' | 'content' | 'content-regular'
...
export default function Paragraph(props: ParagraphProps) {
  ...
  const tailwindVariant = {
    ...
    'mini-title': 'font-poppins text-black text-[14px] font-thin',
